...
(async function() {
  ...
  const items = await Item.create([
    ...
    {name: 'RPG Design and Build', image: '/images/rpg_icon.png', category: categories[3], price: 9999.99, description: "It's like final fantasy; but…' We'd love to hear all about your convoluted storyline, obtuse gameplay mechanics, and over-busy inventory system. We'll even build it for you if the price is right!" },
    ...
    {name: 'Home-Cooked Meal', image: '/images/cooking.png', category: categories[6], price: 99.99, description: "Candlit romance? Beachside surf and turf? You name it we'll make it. Additional materials fees apply."},
